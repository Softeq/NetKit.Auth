        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsAcceptedTermsAndPolicy = table.Column<bool>(nullable: false),
                    TokenRevokedDate = table.Column<DateTimeOffset>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DeletedUserInfo", x => x.UserId);
                    table.ForeignKey(
                        name: "FK_DeletedUserInfo_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalSchema: "auth",
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PasswordHistory_Created",
                schema: "auth",
